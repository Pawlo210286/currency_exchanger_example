 ...
 */
public inline infix fun <A, B, R : Any> Iterable<Pair<A?, B?>>.mapCheckNull(transform: (A, B) -> R): List<R> =
 ...
 * will be removed from the collection.
 */
public inline infix fun <A, B, C, R : Any> Iterable<Triple<A?, B?, C?>>.mapCheckNull(transform: (A, B, C) -> R): List<R> =
 ...
 * will be removed from the collection.
 */
public inline infix fun <A, B, C, D, R : Any> Iterable<Quad<A?, B?, C?, D?>>.mapCheckNull(transform: (A, B, C, D) -> R): List<R> =
