package com.example.multifunctions.models
 ...
 */
public data class Hepta<out A, out B, out C, out D, out E, out F, out G>(
    val first: A,
    val second: B,
    val third: C,
    val fourth: D,
    ...
    override fun toString(): String =
        "Hepta(first=$first, second=$second, third=$third, fourth=$fourth, fifth=$fifth, sixth=$sixth, seventh=$seventh)"
}

/**
 * Converts this hepta into a list.
 */
public fun <T> Hepta<T, T, T, T, T, T, T>.toList(): List<T> =
